...
function checkId_Sync() {
	...
	xhr.open("GET", "checkId?mid=" + form.mid.value, false);
	xhr.send();
...
function checkId_Async() {
	...
	xhr.open("GET", "checkId?mid="+ form.mid.value, true);
			...
			<p>SIGN-UP</p>
				<form name="signupForm" method="post">
					<div class="d-grid gap-2 col-6 mx-auto" class="form-label">
						<label>아이디</label>
						<input type="text" name="mid" onchange="changeId()" class="form-control mb-1"><div onclick="checkId_Async()" class="btn btn-outline-primary btn-sm mb-4">중복확인</div>
					</div>
					<div class="d-grid gap-2 col-6 mx-auto" class="form-label">
						<label>이름</label>
