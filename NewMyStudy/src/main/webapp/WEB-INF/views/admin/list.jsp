				...
				<tbody>
					...
					<c:forEach var="item" items="${list}">
						<tr>
							...
							<td>${item.pw}</td>
							<td>${item.nickname}</td>
							<td><a href="update?mid=${item.mid}" class="btn btn-outline-warning btn-sm">수정</a> <a href="delete?mid=${item.mid}" class="btn btn-outline-danger btn-sm">삭제</a></td>
						</tr>
					</c:forEach>
				</tbody>
				<tfoot>
